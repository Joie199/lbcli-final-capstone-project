...
publickey=$(bitcoin-cli -signet -rpcuser=btrustbuildersrpc -rpcpassword=btrustbuilderspass -rpcconnect=167.172.185.136 -rpcport=38332 getrawtransaction "$tx" 2 | jq -r '.vin[0].txinwitness[1]')
echo "$publickey"